      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Intoxicated child Studio.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Intoxicated child Studio,
            accessible from{" "}
            <a
              href="https://intoxicated.cat-coding.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://intoxicated.cat-coding.com/
            </a>
          </p>
        </li>
        <li>
